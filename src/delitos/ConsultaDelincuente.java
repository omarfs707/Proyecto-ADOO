 ...
 * @author Vreker
 */
public class ConsultaDelincuente extends javax.swing.JInternalFrame {

    /**
     * Creates new form ConsultaDelincuente
     */
    public ConsultaDelincuente() {
        initComponents();
        mostrardatos();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ResultSet rs = Conexion.getTabla("select *from delincuente WHERE iddelincuente='"+valor+"'");
        ...
        public void mostrardatos(){
            ...
            modelo.setColumnIdentifiers(new Object[]{"IdDelito","Nombre","Apellidos","Edad"});
            try{
                while(rs.next()){
                    modelo.addRow(new Object[]{rs.getString("iddelincuente"),rs.getString("nombre"),rs.getString("apellido"),rs.getString("edad")});
                }
