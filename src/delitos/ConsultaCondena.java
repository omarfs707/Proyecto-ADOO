 ...
 * @author Vreker
 */
public class ConsultaCondena extends javax.swing.JInternalFrame {

    /**
     * Creates new form ConsultaCondena
     */
    public ConsultaCondena() {
        initComponents();
        mostrardatos();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ResultSet rs = Conexion.getTabla("select *from condenas WHERE idcondenas='"+valor+"'");
        modelo.setColumnIdentifiers(new Object[]{"IdCondenas","Descripcion","Tipo","Duracion"});
        try{
            while(rs.next()){
